...
def parse_args():
    ...
    # model
    parser.add_argument('--name', default="m88",
...
def main():
    ...
    if config['name'] == "UNET":
        ...
        model = RESNet(1)
    elif config['name'] == "m88":
        model = m88(1)
    elif config['name'] == "m81":
        model = m81(1)
    elif config['name'] == "m97":
        model = m97(1)
    elif config['name'] == "m93":
        model = m93(1)
    elif config['name'] == "m96":
        model = m96(1)
    elif config['name'] == "m90":
        model = m90(1)
